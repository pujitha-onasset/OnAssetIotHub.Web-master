(function() {
    ...
    AlarmsListController.$inject = ['$rootScope', 'SentinelUiSession', 'AlarmsService', 'FeedbackService'];
    function AlarmsListController($rootScope, SentinelUiSession, AlarmsService, FeedbackService) {
        var vm = {
