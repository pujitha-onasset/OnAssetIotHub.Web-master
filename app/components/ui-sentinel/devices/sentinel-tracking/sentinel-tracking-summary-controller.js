(function () {
    ...
    angular
        ...
        .controller('SentinelTrackingSummaryController', SentinelTrackingSummaryController);


    SentinelTrackingSummaryController.$inject = ['$rootScope', '$scope', '$state', '$stateParams','FeedbackService', 'SentinelTrackingReportsService', 'SentinelTrackingFilterService', 'DevicesService', 'ShipmentsService', 'GoogleStaticMapApiKey', 'ClientsService', 'SentinelUiSession','AccountApiService'];
    function SentinelTrackingSummaryController($rootScope, $scope, $state, $stateParams, FeedbackService, SentinelTrackingReportsService, SentinelTrackingFilterService, DevicesService, ShipmentsService, GoogleStaticMapApiKey, ClientsService, SentinelUiSession, AccountApiService) {
        var _timelineDivId = 'summaryTimeline';
        var _printButtonId = 'print-summary-button';
        var _reportsService = SentinelTrackingReportsService;
        var _filterService = SentinelTrackingFilterService;
        var _timeline = {
        ...
        function activate() {
            $rootScope.$on('CLIENT_FOCUS_CHANGED', function (event, args) {
                if ($rootScope.$state.current.name == 'device.sentinelsummary') {
