(function () {
    ...
    angular
        ...
        .factory('WatchlistTrackingFilterService', WatchlistTrackingFilterService);

    WatchlistTrackingFilterService.$inject = ['localStorageService'];
    function WatchlistTrackingFilterService(localStorageService) {
        var localStorageKey = 'WatchlistTrackingFilterService';
        ...
        function filter(report) {
            ...
            if (service.searchText) {
                ...
                isTextMatch = (
                    report.WatchlistName.toLowerCase().indexOf(lowerCaseSearchText) > -1 ||
        ...
        function filterByTemperatureC() {
            ...
            service.range.property = 'temperatureValueC';
        ...
        function filterByTemperatureF() {
            ...
            service.range.property = 'temperatureValueF';
            service.range.min = -255;
            service.range.max = 255;
            service.range.above = service.range.min;
            service.range.below = service.range.max;
