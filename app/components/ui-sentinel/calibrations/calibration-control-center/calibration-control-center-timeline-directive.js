(function () {
    ...
    angular
        ...
        .directive('calibrationControlCenterTimeline', CalibrationControlCenterTimelineDirective);

    function CalibrationControlCenterTimelineDirective() {
        var directive = {
            restrict: 'A',
            controller: ThisDirectiveController,
            controllerAs: 'calibrationControlCenterTimeline',
            templateUrl: 'ui-sentinel-calibrations.calibrationControlCenter/calibration-control-center-timeline-directive.html',
            link: link
        };
        return directive;
    ...
    ThisDirectiveController.$inject = ['$rootScope', '$scope','$filter','CalibrationControlCenterReportsService', 'CalibrationControlCenterFilterService'];
    function ThisDirectiveController($rootScope, $scope, $filter, CalibrationControlCenterReportsService, CalibrationControlCenterFilterService) {
        var timelineDivId = "calibrationControlCenterTimeline";
        ...
        var vm = {
            ...
            options: {
                ...
                dataAxis: {
                    left: {
                        title: {
                            text: CalibrationControlCenterFilterService.reports.filterByPropertyName
                        }
                    }
                }
            },
        ...
        function addItems(reports) {
            ...
            _.forEach(reports, function(report) {
                ...
                console.log("groupIdName",groupIdName);
                var item = {
                    id: report.guid,
                    x: moment(report.timeOfReport).local().toDate().valueOf(),
                    y: 0.5,
