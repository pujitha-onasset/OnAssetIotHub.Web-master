(function () {
    ...
    angular
        ...
        .factory('DeviceTrackingFilterService', DeviceTrackingFilterService);

    DeviceTrackingFilterService.$inject = ['localStorageService'];
    function DeviceTrackingFilterService(localStorageService) {
        var localStorageKey = 'deviceTrackingFilterService';
        ...
        function filterByTempProbe1C() {
            service.filterByPropertyName = 'Temp. Probe1 (\xB0C)';
        ...
        function filterByTempProbe2C() {
            service.filterByPropertyName = 'Temp. Probe2 (\xB0C)';
        ...
        function filterByTempProbe1F() {
            service.filterByPropertyName = 'Temp. Probe1 (\xB0F)';
        ...
        function filterByTempProbe2F() {
            service.filterByPropertyName = 'Temp. Probe2 (\xB0F)';
