(function () {
    ...
    angular
        ...
        .directive('watchlistTrackingTimeline', WatchlistTrackingTimelineDirective);

    function WatchlistTrackingTimelineDirective() {
        var directive = {
            restrict: 'A',
            controller: ThisDirectiveController,
            controllerAs: 'watchlistTrackingTimeline',
            templateUrl: 'ui-sentinel-watchlist/watchlist-tracking-timeline-directive.html',
            link: link
        };
        return directive;
    ...
    ThisDirectiveController.$inject = ['$rootScope', '$scope','$filter','WatchlistTrackingReportsService', 'WatchlistTrackingFilterService'];
    function ThisDirectiveController($rootScope, $scope, $filter, WatchlistTrackingReportsService, WatchlistTrackingFilterService) {
        var timelineDivId = "watchlistTrackingTimeline";
        ...
        var vm = {
            ...
            options: {
                ...
                dataAxis: {
                    left: {
                        title: {
                            text: WatchlistTrackingFilterService.filterByPropertyName
                        }
                    }
                }
            },
        ...
        function activate() {
            ...
            $scope.$watch(
                ...
                function () {
                    if ($rootScope.$state.current.name !== 'watchlist.tracking') {
                        return;
                    }
        ...
        function onRangeChange() {
            ...
            onRangeTimeout = window.setTimeout(
                function() {
                    vm.reportsService.load(vm.reportsService.watchlist, moment(timelineWindow.start), moment(timelineWindow.end),false);
