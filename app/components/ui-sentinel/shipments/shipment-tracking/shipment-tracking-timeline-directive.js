(function () {
    ...
    angular
        ...
        .directive('shipmentTrackingTimeline', ShipmentTrackingTimelineDirective);

    function ShipmentTrackingTimelineDirective() {
        var directive = {
            restrict: 'A',
            controller: ThisDirectiveController,
            controllerAs: 'shipmentTrackingTimeline',
            templateUrl: 'ui-sentinel-shipments.shipmentTracking/shipment-tracking-timeline-directive.html',
            link: link
        };
        return directive;
    ...
    ThisDirectiveController.$inject = ['$rootScope', '$scope', '$filter', 'ShipmentTrackingReportsService', 'ShipmentTrackingFilterService'];
    function ThisDirectiveController($rootScope, $scope, $filter, ShipmentTrackingReportsService, ShipmentTrackingFilterService) {
        var timelineDivId = 'shipmentTrackingTimeline';
        ...
        var vm = {
            ...
            options: {
                ...
                dataAxis: {
                    left: {
                        title: {
                            text: ShipmentTrackingFilterService.filterByPropertyName
                        }
                    }
                }
            },
            ...
            vm.timeline.setOptions(
                {
                    ...
                    groups: {
                        visibility: {
                            ...
                            'warning-anchor': vm.filterService.showWarning,
                            ...
                            'ok-anchor-selected': vm.filterService.showOk,
                            ...
                            'info-anchor-selected': vm.filterService.showInfo,
                            ...
                            'warning-anchor-selected': vm.filterService.showWarning
                        }
                    }
                }
            );
        ...
        function onRangeChange() {
            ...
            onRangeTimeout = window.setTimeout(
                function() {
                    vm.reportsService.load(moment(timelineWindow.start), moment(timelineWindow.end),true);
