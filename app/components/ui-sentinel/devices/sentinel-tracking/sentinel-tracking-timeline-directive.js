(function () {
    ...
    angular
        ...
        .directive('sentinelTrackingTimeline', SentinelTrackingTimelineDirective);

    function SentinelTrackingTimelineDirective() {
        var directive = {
            restrict: 'A',
            controller: ThisDirectiveController,
            controllerAs: 'sentinelTrackingTimeline',
            templateUrl: 'ui-sentinel-devices.sentinelTracking/sentinel-tracking-timeline-directive.html',
            link: link
        };
        return directive;
    ...
    ThisDirectiveController.$inject = ['$rootScope', '$scope','$filter', 'SentinelTrackingReportsService', 'SentinelTrackingFilterService'];
    function ThisDirectiveController($rootScope, $scope,$filter, SentinelTrackingReportsService, SentinelTrackingFilterService) {
        var timelineDivId = "sentinelTrackingTimeline";
        ...
        var vm = {
            ...
            options: {
                ...
                dataAxis: {
                    left: {
                        title: {
                            text: SentinelTrackingFilterService.filterByPropertyName
                        }
                    }
                }
            },
