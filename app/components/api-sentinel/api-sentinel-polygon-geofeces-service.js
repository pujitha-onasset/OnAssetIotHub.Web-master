(function() {
    ...
    angular
        .module('api-sentinel')
        .factory('PolygonGeofencesService', PolygonGeofencesService);

    PolygonGeofencesService.$inject = ['$resource', 'SENTINEL_API_HOST_CONSTANTS'];

     function PolygonGeofencesService($resource, HOST) {
        var api = $resource(HOST.URL + '/rest/1/polygongeofences', {}, {
            addGeofence: { method: 'POST' },
            getGeofences: { method: 'GET', isArray: true},
            getGeofence: { method: 'GET', params: { geofenceId: '@geofenceId'}, url: HOST.URL + '/rest/1/polygongeofences/:geofenceId'},
            updateGeofence: { method: 'PUT', params: { geofenceId: '@geofenceId' }, url: HOST.URL + '/rest/1/polygongeofences/:geofenceId'},
            removeGeofence: { method: 'DELETE', params: { geofenceId: '@geofenceId' }, url: HOST.URL + '/rest/1/polygongeofences/:geofenceId'},
            getAlarms: { method: 'GET', params: { geofenceId: '@geofenceId'}, url: HOST.URL + '/rest/1/polygongeofences/GetAlarmsOfGeofence', isArray: true},
        });
