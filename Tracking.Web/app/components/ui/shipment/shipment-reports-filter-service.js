(function () {
    ...
    angular
        ...
        .factory('ShipmentReportsFilterService', ShipmentReportsFilterService);

    ShipmentReportsFilterService.$inject = ['localStorageService'];
    function ShipmentReportsFilterService(localStorageService) {
        var filterSettings = localStorageService.get('shipmentReportsFilterService');
        ...
        function save() {
            ...
            localStorageService.set('shipmentReportsFilterService', filterSettings);
        }
    }
})();