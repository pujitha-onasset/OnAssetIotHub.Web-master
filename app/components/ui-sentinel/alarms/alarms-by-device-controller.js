(function() {
    ...
    angular
        ...
        .controller('AlarmsByDeviceController', AlarmsByDeviceController);

    AlarmsByDeviceController.$inject = ['$rootScope', '$state', 'SentinelUiSession', 'AlarmsService', 'FeedbackService'];
    function AlarmsByDeviceController($rootScope, $state, SentinelUiSession, AlarmsService, FeedbackService) {
        var vm = {
        ...
        function load() {
            ...
            var promise = AlarmsService.getAlarmsDevice($state.params.device).$promise;
            promise.then(
                function(result) {
                    vm.list = result;
                },
